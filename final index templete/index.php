...
<head>
	...
	<meta name="keywords" content="Preamble Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
...
<body>
		...
		<nav class="navbar navbar-default">
			<div class="navbar-header navbar-left">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<span class="icon-bar"></span>
				<h1><a class="navbar-brand" href="index.html"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Complaint Management System</a></h1>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav>
					<ul class="nav navbar-nav">
						...
						<li><a href="\gayatri-complaint management\admin templete\admin login.php" class="hvr-underline-from-center">Admin Login</a></li>
						<li><a href="\gayatri-complaint management\user templete\user login.php" class="hvr-underline-from-center">User Login</a></li>
	...
	<img src="images\l6.png"  width="1500" height="600">
	<!-- //banner -->
	<!-- /banner_bottom -->
		...
		<div class="container">
			<div class="inner_sec_top_aglieits">
				<div class="banner_bottom_info">
					<h4><img src="images/men_2.jpg" alt=" " class="img-responsive"> Here you will find my resume...</h4>
	...
	<div class="contact_sec" id="contact">
		<div class="container">
			...
			<ul class="address two">
				<li><i class="fa fa-map-marker" aria-hidden="true"></i> Honey block,New York City.</li>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@example.com</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>+918 780 8894</li>
			</ul>
		</div>
	</div>
	<!-- //contact -->

...
<script type="text/javascript">
	function validateform()
	{
		...
		var x10 = document.forms["myform"]["date"].value;
		if (x10 == "")
		{
...
<div class="w3layouts-main">
	...
	<div class="panel-body">
 	<div class=" form">
		<form class="cmxform form-horizontal" novalidate="novalidate" method="POST" name="myform"  onSubmit="return validateform()" enctype="multipart/form-data"  id="registerform" action="">

			<div class="form-group ">
				<label><b>Name:</b></label>
				<div><input type="text" name="name" id="name" class="ggg" placeholder="Enter your name" class="form-control"></div>
			</div>
			...
			<div class="form-group ">
						...
						<div>
							<select name="department" id="department">
								...
								<option value="mechanical">Diploma Of Electronic Engineering</option>
							</select>
						</div>
			</div>
			<br>
		...
		<div class="form-group ">	
			<div><b>Photo:</b></div>
			<div>
				<img id="preview_img" src="images\1.png" height="100" width="100" />
				<input type="file" name="photo" id="photo" class="fileinput" accept=" .png, .jpg, .jpeg"></div>
			</div>

			<div class="form-group ">
				<label><b>Date:</b></label>
				<div><input type="Date" name="date"  id="date" class="form-control"></div>
			</div>
...
if(isset($_POST['submit']))
{
	...
	$result=mysqli_query($mysqli,"INSERT into registration values('','$name','$roll','$username','$email','$pass','$cpass','$mobile','$department','$year','$gender','$photo','$date')");
